...
function SettingsSheet({
  ...
  const hasSpeaker = outputDiagnostics.available && (voiceConfig.config.enabled || wake.available)
              ...
              {hasAdvanced && <div className="settings-advanced">
                ...
                {advancedOpen && <div className="settings-advanced-body">
                  ...
                  {hasSpeaker && <div className="settings-group">
                    ...
                    <p className="settings-note">Playing to “{outputDiagnostics.routedLabel}”. The assistant, the listening cue and the timer chime all use this; automatic follows the system default and steps off a VB-CABLE default.</p>
                  </div>}
                </div>}
              </div>}
            </>}
